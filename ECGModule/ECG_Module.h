#pragma once
/*
 * The code acquires the data across the selected lead pair and calls
 * TMDQueue_insert() to store them.
 */
#include <stdio.h>
...
struct TMDQueue* RCG_Module_getItsTMDQueue(const ECG_Module* const me);
